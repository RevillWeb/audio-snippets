 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const A=new class{handleAttributeExpressions(t,e,i){const s=e[0];return"."===s?new E(t,e.slice(1),i).parts:"@"===s?[new $(t,e.slice(1))]:"?"===s?[new T(t,e.slice(1),i)]:new P(t,e,i).parts}handleTextExpression(t){return new N(t)}},O=(t,...e)=>new w(t,e,"html",A),k=(t,e)=>`${t}--${e}`;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
