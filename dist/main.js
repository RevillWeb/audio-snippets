 ...
 * http://polymer.github.io/PATENTS.txt
 */
const w=t=>null===t||!("object"==typeof t||"function"==typeof t);class P{constructor(t,e,i){this.dirty=!0,this.element=t,this.name=e,this.strings=i,this.parts=[];for(let t=0;t<i.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new S(this)}_getValue(){const t=this.strings,e=t.length-1;let i="";for(let s=0;s<e;s++){i+=t[s];const e=this.parts[s];if(void 0!==e){const t=e.value;if(null!=t&&(Array.isArray(t)||"string"!=typeof t&&t[Symbol.iterator]))for(const e of t)i+="string"==typeof e?e:String(e);else i+="string"==typeof t?t:String(t)}}return i+=t[e]}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class S{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===y||w(t)&&t===this.value||(this.value=t,_(t)||(this.committer.dirty=!0))}commit(){for(;_(this.value);){const t=this.value;this.value=y,t(this)}this.value!==y&&this.committer.commit()}}class N{constructor(t){this.value=void 0,this._pendingValue=void 0,this.templateFactory=t}appendInto(t){this.startNode=t.appendChild(d()),this.endNode=t.appendChild(d())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t._insert(this.startNode=d()),t._insert(this.endNode=d())}insertAfterPart(t){t._insert(this.startNode=d()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this._pendingValue=t}commit(){for(;_(this._pendingValue);){const t=this._pendingValue;this._pendingValue=y,t(this)}const t=this._pendingValue;t!==y&&(w(t)?t!==this.value&&this._commitText(t):t instanceof x?this._commitTemplateResult(t):t instanceof Node?this._commitNode(t):Array.isArray(t)||t[Symbol.iterator]?this._commitIterable(t):void 0!==t.then?this._commitPromise(t):this._commitText(t))}_insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}_commitNode(t){this.value!==t&&(this.clear(),this._insert(t),this.value=t)}_commitText(t){const e=this.startNode.nextSibling;t=null==t?"":t,e===this.endNode.previousSibling&&e.nodeType===Node.TEXT_NODE?e.textContent=t:this._commitNode(document.createTextNode("string"==typeof t?t:String(t))),this.value=t}_commitTemplateResult(t){const e=this.templateFactory(t);if(this.value&&this.value.template===e)this.value.update(t.values);else{const i=new b(e,t.processor,this.templateFactory),s=i._clone();i.update(t.values),this._commitNode(s),this.value=i}}_commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let i,s=0;for(const n of t)void 0===(i=e[s])&&(i=new N(this.templateFactory),e.push(i),0===s?i.appendIntoPart(this):i.insertAfterPart(e[s-1])),i.setValue(n),i.commit(),s++;s<e.length&&(e.length=s,this.clear(i&&i.endNode))}_commitPromise(t){this.value=t,t.then(e=>{this.value===t&&(this.setValue(e),this.commit())})}clear(t=this.startNode){g(this.startNode.parentNode,t.nextSibling,this.endNode)}}class T{constructor(t,e,i){if(this.value=void 0,this._pendingValue=void 0,2!==i.length||""!==i[0]||""!==i[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=i}setValue(t){this._pendingValue=t}commit(){for(;_(this._pendingValue);){const t=this._pendingValue;this._pendingValue=y,t(this)}if(this._pendingValue===y)return;const t=!!this._pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name)),this.value=t,this._pendingValue=y}}class E extends P{constructor(t,e,i){super(t,e,i),this.single=2===i.length&&""===i[0]&&""===i[1]}_createPart(){return new M(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class M extends S{}class ${constructor(t,e){this.value=void 0,this._pendingValue=void 0,this.element=t,this.eventName=e}setValue(t){this._pendingValue=t}commit(){for(;_(this._pendingValue);){const t=this._pendingValue;this._pendingValue=y,t(this)}this._pendingValue!==y&&(null==this._pendingValue!=(null==this.value)&&(null==this._pendingValue?this.element.removeEventListener(this.eventName,this):this.element.addEventListener(this.eventName,this)),this.value=this._pendingValue,this._pendingValue=y)}handleEvent(t){"function"==typeof this.value?this.value.call(this.element,t):"function"==typeof this.value.handleEvent&&this.value.handleEvent(t)}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function A(t,e,i=function(t){let e=V.get(t.type);void 0===e&&(e=new Map,V.set(t.type,e));let i=e.get(t.strings);return void 0===i&&(i=new a(t,t.getTemplateElement()),e.set(t.strings,i)),i}){let s=C.get(e);void 0===s&&(g(e,e.firstChild),C.set(e,s=new N(i)),s.appendInto(e)),s.setValue(t),s.commit()}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const F=new class{handleAttributeExpressions(t,e,i){const s=e[0];return"."===s?new E(t,e.slice(1),i).parts:"@"===s?[new $(t,e.slice(1))]:"?"===s?[new T(t,e.slice(1),i)]:new P(t,e,i).parts}handleTextExpression(t){return new N(t)}},O=(t,...e)=>new x(t,e,"html",F),z=(t,e)=>`${t}--${e}`;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
J((t,e)=>t.querySelector(e)),J((t,e)=>t.querySelectorAll(e));function J(t){return e=>(i,s)=>{Object.defineProperty(i,s,{get(){return t(this.renderRoot,e)},enumerable:!0,configurable:!0})}}class K extends Z{update(t){if(super.update(t),"function"!=typeof this.render)throw new Error("render() not implemented");this.constructor.render(this.render(),this.renderRoot,this.localName)}}K.render=function(t,e,i){const s=C.has(e);if(A(t,e,R(i)),e instanceof ShadowRoot&&k&&t instanceof x){if(!L.has(i)){const t=C.get(e).value;B(e,t.template,i)}s||window.ShadyCSS.styleElement(e.host)}};customElements.define("audio-recorder",class extends K{static get properties(){return{recording:{type:Boolean},saving:{type:Boolean},seconds:{type:Number}}}constructor(){super(),this._ticker=null,this._chunks=[],this._recorder=null}_startRecording(t){t.preventDefault&&t.preventDefault(),t.stopPropagation&&t.stopPropagation(),t.cancelBubble=!0,t.returnValue=!1,navigator.mediaDevices.getUserMedia({audio:!0}).then(t=>{this._recorder=new MediaRecorder(t),this.seconds=0,this._ticker=setInterval(()=>this.seconds++,1e3),this.recording=!0,window.navigator.vibrate(100),this._recorder.start(),this._recorder.addEventListener("dataavailable",t=>{this._chunks.push(t.data)})})}_stopRecording(){this._recorder.addEventListener("stop",t=>{console.log("STOPPED:",t),this.dispatchEvent(new CustomEvent("audio-recorded",{detail:{date:new Date,blob:new Blob(this._chunks)}})),this._chunks=[],this._recorder=null,this.saving=!1}),clearInterval(this._ticker),this.recording=!1,this.saving=!0,this._recorder.stop()}render(){return O`
        ...
        `}});customElements.define("audio-player",class extends K{static get properties(){return{playing:{type:Boolean},duration:{type:Number},seconds:{type:Number},src:{type:String,attribute:!0},date:{type:String}}}constructor(){super(),this._$audio=null,this._ticker=null,this._metadataLoaded=this._metadataLoaded.bind(this)}toggle(){this.playing?(this._$audio.pause(),this._$audio.currentTime=0,this.playing=!1,clearInterval(this._ticker)):(this.playing=!0,this._$audio.addEventListener("ended",()=>{this.playing=!1,clearInterval(this._ticker)},{once:!0}),this.seconds=0,this._ticker=setInterval(()=>this.seconds++,1e3),this._$audio.play())}updateComplete(){console.log("URL:",this.src+""),this._$audio=this.shadowRoot.getElementById("audio"),this._$audio.addEventListener("loadedmetadata",t=>{console.log(t)},{once:!0})}_metadataLoaded(){null===this._$audio&&(this._$audio=this.shadowRoot.getElementById("audio")),this._$audio.duration===1/0?(this._$audio.addEventListener("timeupdate",()=>{this._$audio.currentTime=0,this.duration=this._$audio.duration},{once:!0}),this._$audio.currentTime=1e6):this.duration=this._$audio.duration}_getDays(){const t=Math.round(Math.abs((new Date(this.date).getTime()-(new Date).getTime())/864e5));return t>0?O`Recorded ${t} days ago`:O`Recorded today`}_getDuration(){const t=Math.round(this.duration,1);return O`${t} second${0===t||t>1?"s":""}`}render(){return O`
            <style>
                :host {
                    display: flex;
                    padding: 1rem .5rem;                    
        ...
        `}});let Q=[];const Y=document.getElementById("list");document.querySelector("audio-recorder").addEventListener("audio-recorded",t=>{A(function(t){return console.log("DATA:",t),O`${t.map(t=>O`
        <div class="item"><audio-player src=${t.url} date=${t.date}></audio-player></div>
    `)}`}(Q=[{...t.detail,url:URL.createObjectURL(t.detail.blob)},...Q]),Y)})}]);